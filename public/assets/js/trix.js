        ...
        if (!t.JsMutationObserver) {
          ...
          s.prototype = {
            observe: function (t, e) {
              if (
                ((t = n(t)), (!e.childList && !e.attributes && !e.characterData) || (e.attributeOldValue && !e.attributes) || (e.attributeFilter && e.attributeFilter.length && !e.attributes) || (e.characterDataOldValue && !e.characterData))
              )
        ...
        function () {
          ...
          (e.registerElement = function (t, e) {
            ...
            (i = function (e) {
              var n, i;
              return (
                (n = document.createElement("style")), n.setAttribute("type", "text/css"), n.setAttribute("data-tag-name", e.toLowerCase()), (i = t()) && n.setAttribute("nonce", i), document.head.insertBefore(n, document.head.firstChild), n
              );
            }),
            (t = function () {
              var t;
                  ...
                  return (
                    ...
                    this.inputSummary.preferDocument
                      ...
                      : ((e = null != a ? a === this.inputSummary.textAdded : !this.inputSummary.textAdded),
                        ...
                        (l = "\n" === u && !n),
                        (s = (c && !l) || (l && !c)),
                        s && (o = this.getSelectedRange()) && ((i = c ? a.replace(/\n$/, "").length || -1 : (null != a ? a.length : void 0) || 1), null != (r = this.responder) ? r.positionIsBlockBreak(o[1] + i) : void 0) ? !0 : e && n)
                  );
                }),
                ...
                (s.prototype.events = {
                  ...
                  keypress: function (t) {
                    ...
                    if (null == this.inputSummary.eventName && !t.metaKey && (!t.ctrlKey || t.altKey))
                      return (i = p(t))
                        ? (null != (e = this.delegate) && e.inputControllerWillPerformTyping(), null != (n = this.responder) && n.insertString(i), this.setInputSummary({ textAdded: i, didDelete: this.selectionIsExpanded() }))
                        : void 0;
                  },
                  textInput: function (t) {
                    ...
                    return (
                      ...
                      o && o !== e && o.toUpperCase() === e
                        ? ((n = this.getSelectedRange()), this.setSelectedRange([n[0], n[1] + o.length]), null != (i = this.responder) && i.insertString(e), this.setInputSummary({ textAdded: e }), this.setSelectedRange(n))
                        : void 0
                    );
                  },
                  ...
                  cut: function (t) {
                    ...
                    return (null != (e = this.responder) ? e.selectionIsExpanded() : void 0) &&
                      (this.serializeSelectionToDataTransfer(t.clipboardData) && t.preventDefault(), null != (n = this.delegate) && n.inputControllerWillCutText(), this.deleteInDirection("backward"), t.defaultPrevented)
                      ? this.requestRender()
                      : void 0;
                  },
                  copy: function (t) {
                  ...
                  paste: function (t) {
                    ...
                    return (
                      ...
                      null == n || h(t)
                        ...
                        : ((a = n.getData("URL"))
                            ? ((l.type = "text/html"),
                              (L = (c = n.getData("public.url-name")) ? e.squishBreakableWhitespace(c).trim() : a),
                ...
                (u.prototype.events = {
                  ...
                  paste: function (t) {
                    ...
                    return h(t)
                      ...
                      : p(t)
                      ? (t.preventDefault(),
                        (n = { type: "text/plain", string: t.clipboardData.getData("text/plain") }),
                  ...
                  drop: function (t) {
                    ...
                    return this.dragging
                      ? (t.preventDefault(), null != (n = this.delegate) && n.inputControllerWillMoveText(), null != (i = this.responder) && i.moveTextFromRange(this.dragging.range), (this.dragging = null), this.scheduleRender())
                      : c(t)
                  ...
                  insertFromPaste: function () {
                    ...
                    return (
                      ...
                      (i = n.getData("URL"))
                        ? (this.event.preventDefault(),
                          (s.type = "text/html"),
                          (p = (r = n.getData("public.url-name")) ? e.squishBreakableWhitespace(r).trim() : i),
            ...
            (e.AttachmentEditorController = (function (a) {
              ...
              return (
                    ...
                    (n = s({
                      ...
                      childNodes: s({
                        ...
                        childNodes: s({
                          ...
                          childNodes: s({ tagName: "button", className: "trix-button trix-button--remove", textContent: r.remove, attributes: { title: r.remove }, data: { trixAction: "remove" } }),
                        }),
                      }),
                    })),
                      ...
                      n.appendChild(
                        s({
                          ...
                          childNodes: s({
                            ...
                            childNodes: [
                              s({ tagName: "span", className: t.attachmentName, textContent: this.attachment.getFilename(), attributes: { title: this.attachment.getFilename() } }),
                              s({ tagName: "span", className: t.attachmentSize, textContent: this.attachment.getFormattedFilesize() }),
                            ],
                          }),
                        })
                      ),
                    i("click", { onElement: n, withCallback: this.didClickToolbar }),
                    i("click", { onElement: n, matchingSelector: "[data-trix-action]", withCallback: this.didClickActionButton }),
                    {
                      do: (function (t) {
                        return function () {
                ...
                (h.prototype.installCaptionEditor = p(function () {
                  var o, a, u, c, l;
                  return (
                    (c = s({ tagName: "textarea", className: t.attachmentCaptionEditor, attributes: { placeholder: r.captionPlaceholder }, data: { trixMutable: !0 } })),
              ...
              return (
                  ...
                  if (
                    ...
                    this.block.isEmpty()
                      ...
                      : ((p = null != (l = n(this.block.getLastAttribute())) ? l.text : void 0),
                        (d = this.findOrCreateCachedChildView(e.TextView, this.block.text, { textConfig: p })),
                        c.push.apply(c, d.getNodes()),
                        this.shouldAddExtraNewlineElement() && c.push(i("br"))),
                    this.attributes.length)
                  )
                    return c;
                  for (h = e.config.blockAttributes["default"].tagName, this.block.isRTL() && (t = { dir: "rtl" }), r = i({ tagName: h, attributes: t }), s = 0, a = c.length; a > s; s++) (u = c[s]), r.appendChild(u);
                  return [r];
                }),
                (s.prototype.createContainerElement = function (e) {
                  ...
                  return (
                    ...
                    "attachmentGallery" === o && ((a = this.block.getBlockBreakPosition()), (s = t.attachmentGallery + " " + t.attachmentGallery + "--" + a)),
              ...
              return (
                    ...
                    (function (t) {
                      return function (e, n) {
                        return (
                          ...
                          t.attributes[n] || t.dialogIsVisible(n) ? (e.setAttribute("data-trix-active", ""), e.classList.add("trix-active")) : (e.removeAttribute("data-trix-active"), e.classList.remove("trix-active"))
                        );
                      };
                    })(this)
                  );
                ...
                (s.prototype.setAttribute = function (t) {
                  ...
                  return (
                    (e = f(t)),
                    (n = m(t, e)),
                    n.willValidate && !n.checkValidity() ? (n.setAttribute("data-trix-validate", ""), n.classList.add("trix-validate"), n.focus()) : (null != (i = this.delegate) && i.toolbarDidUpdateAttribute(e, n.value), this.hideDialog())
                  );
                }),
                    ...
                    i
                      .then(
                        (function (e) {
                          return function (i) {
                            var o, r;
                            return (r = i.width), (o = i.height), (e.getWidth() && e.getHeight()) || e.setAttributes({ width: r, height: o }), (e.preloadingURL = null), e.setPreviewURL(t), "function" == typeof n ? n() : void 0;
                          };
                        })(this)
                      )
                      ["catch"](
              ...
              return (
                ...
                (i.prototype.splitObjectAtPosition = function (t) {
                  ...
                  return (
                    ...
                    null != e ? (0 === r ? ((c = e), (l = 0)) : ((i = this.getObjectAtIndex(e)), (a = i.splitAtOffset(r)), (n = a[0]), (u = a[1]), o.splice(e, 1, n, u), (c = e + 1), (l = n.getLength() - r))) : ((c = o.length), (l = 0)),
                    [o, c, l]
                  );
                }),
            ...
            (e.HTMLSanitizer = (function (r) {
              ...
              return (
                ...
                (p = function (t) {
                  var e, n, i, o, r;
                  for (
                    null == t && (t = ""), t = t.replace(/<\/html[^>]*>[^]*$/i, "</html>"), e = document.implementation.createHTMLDocument(""), e.documentElement.innerHTML = t, r = e.head.querySelectorAll("style"), i = 0, o = r.length;
                    o > i;
                    i++
                  )
            ...
            (e.HTMLParser = (function (d) {
              ...
              return (
                ...
                (g.prototype.parse = function () {
                  var t, n;
                  try {
                    for (this.createHiddenContainer(), t = e.HTMLSanitizer.sanitize(this.html).getHTML(), this.containerElement.innerHTML = t, n = h(this.containerElement, { usingFilter: x }); n.nextNode(); )
                ...
                (g.prototype.appendBlockForTextNode = function (e) {
                  ...
                  return (
                    ...
                    i === this.currentBlockElement && this.isBlockElement(e.previousSibling)
                      ...
                      : (i !== this.containerElement && !this.isBlockElement(i)) || ((n = this.getBlockAttributes(i)), t(n, null != (o = this.currentBlock) ? o.attributes : void 0))
                      ? void 0
                      : ((this.currentBlock = this.appendBlockForAttributesWithElement(n, i)), (this.currentBlockElement = i))
                  );
                }),
                ...
                (g.prototype.isInsignificantTextNode = function (t) {
                  var e, n, i;
                  if ((null != t ? t.nodeType : void 0) === Node.TEXT_NODE && k(t.data) && ((n = t.parentNode), (i = t.previousSibling), (e = t.nextSibling), (!C(n.previousSibling) || this.isBlockElement(n.previousSibling)) && !v(n)))
              ...
              return (
                ...
                (c.prototype.mergeDocumentAtRange = function (e, n) {
                  ...
                  return (
                    ...
                    t(r, a.getAttributes())
                      ? ((u = a.getTextWithoutBlockBreak()), (p = this.insertTextAtRange(u, n)), s > 1 && ((c = new this.constructor(c.getBlocks().slice(1))), (h = f + u.getLength()), (p = p.insertDocumentAtRange(c, h))))
              ...
              return (
                ...
                (d.prototype.setTextAttribute = function (t, n) {
                  ...
                  if ((o = this.getSelectedRange()))
                    return (r = o[0]), (i = o[1]), r !== i ? this.setDocument(this.document.addAttributeAtRange(t, n, o)) : "href" === t ? ((s = e.Text.textForStringWithAttributes(n, { href: n })), this.insertText(s)) : void 0;
                }),
                ...
                (d.prototype.canIncreaseNestingLevel = function () {
                  var e, n, i;
                  if ((e = this.getBlock()))
                    return (null != (i = o(e.getLastNestableAttribute())) ? i.listAttribute : 0) ? ((n = this.getPreviousBlock()) ? t(n.getListItemAttributes(), e.getListItemAttributes()) : void 0) : e.getNestingLevel() > 0;
                }),
                  ...
                  for (i = 0, r = this.findRangesOfPieces(), s = [], t = 0, n = r.length; n > t; t++)
                    (o = r[t]),
                      o[1] - o[0] > 1 &&
                        ((o[0] += i),
                        (o[1] += i),
                        "\n" !== this.document.getCharacterAtPosition(o[1]) && ((this.document = this.document.insertBlockBreakAtRange(o[1])), o[1] < this.selectedRange[1] && this.moveSelectedRangeForward(), o[1]++, i++),
                        0 !== o[0] && "\n" !== this.document.getCharacterAtPosition(o[0] - 1) && ((this.document = this.document.insertBlockBreakAtRange(o[0])), o[0] < this.selectedRange[0] && this.moveSelectedRangeForward(), o[0]++, i++),
            ...
            (e.LocationMapper = (function () {
              ...
              return (
                (e.prototype.findLocationFromContainerAndOffset = function (e, i, o) {
                  var s, u, l, p, g, m, v;
                  for (
                    m = (null != o ? o : { strict: !0 }).strict, u = 0, l = !1, p = { index: 0, offset: 0 }, (s = this.findAttachmentElementParentForNode(e)) && ((e = s.parentNode), (i = n(s))), v = h(this.element, { usingFilter: f });
                    v.nextNode();
            ...
            (e.SelectionManager = (function (d) {
              ...
              return (
                ...
                (f.prototype.getLocationRange = function (t) {
                  var e, i;
                  return (
                    null == t && (t = {}), (e = t.strict === !1 ? this.createLocationRangeFromDOMRange(n(), { strict: !1 }) : t.ignoreLock ? this.currentLocationRange : null != (i = this.lockedLocationRange) ? i : this.currentLocationRange)
                  );
                }),
              ...
              return (
                ...
                (u.prototype.updateCurrentActions = function () {
                  ...
                  return (
                    ...
                    n(t, this.currentActions) ? void 0 : ((this.currentActions = t), this.toolbarController.updateActions(this.currentActions), this.notifyEditorElement("actions-change", { actions: this.currentActions }))
                  );
                }),
                ...
                return (
                  ...
                  (d = function (t) {
                    return ("function" == typeof document.queryCommandSupported ? document.queryCommandSupported("enableObjectResizing") : void 0)
                      ? (document.execCommand("enableObjectResizing", !1, !1), o("mscontrolselect", { onElement: t, preventDefault: !0 }))
                      : void 0;
                  }),
                  (v = function () {
                    var t;
                    return ("function" == typeof document.queryCommandSupported ? document.queryCommandSupported("DefaultParagraphSeparator") : void 0) && ((t = e.config.blockAttributes["default"].tagName), "div" === t || "p" === t)
                  ...
                  })()),
                  {
                    ...
                    labels: {
                      get: function () {
                        ...
                        return (
                          (e = []),
                          this.id && this.ownerDocument && e.push.apply(e, this.ownerDocument.querySelectorAll("label[for='" + this.id + "']")),
                          (t = i(this, { matchingSelector: "label" })) && ((n = t.control) === this || null === n) && e.push(t),
                          e
                        );
                      },
                    },
                      ...
                      get: function () {
                        ...
                        return this.hasAttribute("toolbar")
                          ? null != (e = this.ownerDocument)
                            ...
                            : void 0
                          : this.parentNode
                          ? ((n = "trix-toolbar-" + this.trixId), this.setAttribute("toolbar", n), (t = s("trix-toolbar", { id: n })), this.parentNode.insertBefore(t, this), t)
                          : void 0;
                      },
                    },
                    inputElement: {
                      get: function () {
                        ...
                        return this.hasAttribute("input")
                          ? null != (n = this.ownerDocument)
                            ...
                            : void 0
                          : this.parentNode
                          ? ((e = "trix-input-" + this.trixId), this.setAttribute("input", e), (t = s("input", { type: "hidden", id: e })), this.parentNode.insertBefore(t, this.nextElementSibling), t)
                          : void 0;
                      },
                    },
                    editor: {
                    ...
                    notify: function (t, e) {
                      return this.editorController ? a("trix-" + t, { onElement: this, attributes: e }) : void 0;
                    },
                    ...
                    clickBubbled: function (t) {
                      var e;
                      if (!(t.defaultPrevented || this.contains(t.target) || !(e = i(t.target, { matchingSelector: "label" })) || u.call(this.labels, e) < 0)) return this.focus();
                    },
                    reset: function () {
